...
with st.form("triage_form"):
  ...
  c1, c2, c3, c4 = st.columns(4) #can try to divide to 3 column
  with c1:
  ...
  c5, _, _, _ = st.columns(4) # _ = empty column
  with c5:
 ...
 # Section 3 — Severity
  ...
  #copy the data to ai and ai will start prediction
